 ...
 */
export declare class VaryingNode<D extends Any> extends Node<D> {
    ...
    constructor(source: Node<D>, name?: string | null);
    /**
...
export declare const varying: <D extends Any>(source: Node<D>, name?: string) => VaryingNode<D>;
