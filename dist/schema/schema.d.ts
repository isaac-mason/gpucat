...
export type mat2x2f = {
    ...
    readonly wgslType: 'mat2x2f';
};
export declare const mat2x2f: mat2x2f;
export type mat2x3f = {
    readonly type: 'mat2x3f';
    readonly wgslType: 'mat2x3f';
};
export declare const mat2x3f: mat2x3f;
export type mat2x4f = {
    readonly type: 'mat2x4f';
    readonly wgslType: 'mat2x4f';
};
export declare const mat2x4f: mat2x4f;
export type mat3x2f = {
    readonly type: 'mat3x2f';
    readonly wgslType: 'mat3x2f';
};
export declare const mat3x2f: mat3x2f;
export type mat3x3f = {
    readonly type: 'mat3x3f';
    readonly wgslType: 'mat3x3f';
};
export declare const mat3x3f: mat3x3f;
export type mat3x4f = {
    readonly type: 'mat3x4f';
    readonly wgslType: 'mat3x4f';
};
export declare const mat3x4f: mat3x4f;
export type mat4x2f = {
    readonly type: 'mat4x2f';
    readonly wgslType: 'mat4x2f';
};
export declare const mat4x2f: mat4x2f;
export type mat4x3f = {
    readonly type: 'mat4x3f';
    readonly wgslType: 'mat4x3f';
};
...
export type MatfDesc = mat2x2f | mat2x3f | mat2x4f | mat3x2f | mat3x3f | mat3x4f | mat4x2f | mat4x3f | mat4x4f;
export type mat2x2h = {
    readonly type: 'mat2x2h';
    readonly wgslType: 'mat2x2h';
};
export declare const mat2x2h: mat2x2h;
export type mat2x3h = {
    readonly type: 'mat2x3h';
    readonly wgslType: 'mat2x3h';
};
export declare const mat2x3h: mat2x3h;
export type mat2x4h = {
    readonly type: 'mat2x4h';
    readonly wgslType: 'mat2x4h';
};
export declare const mat2x4h: mat2x4h;
export type mat3x2h = {
    readonly type: 'mat3x2h';
    readonly wgslType: 'mat3x2h';
};
export declare const mat3x2h: mat3x2h;
export type mat3x3h = {
    readonly type: 'mat3x3h';
    readonly wgslType: 'mat3x3h';
};
export declare const mat3x3h: mat3x3h;
export type mat3x4h = {
    readonly type: 'mat3x4h';
    readonly wgslType: 'mat3x4h';
};
export declare const mat3x4h: mat3x4h;
export type mat4x2h = {
    readonly type: 'mat4x2h';
    readonly wgslType: 'mat4x2h';
};
export declare const mat4x2h: mat4x2h;
export type mat4x3h = {
    readonly type: 'mat4x3h';
    readonly wgslType: 'mat4x3h';
};
export declare const mat4x3h: mat4x3h;
export type mat4x4h = {
    readonly type: 'mat4x4h';
    readonly wgslType: 'mat4x4h';
};
export declare const mat4x4h: mat4x4h;
export type MathDesc = mat2x2h | mat2x3h | mat2x4h | mat3x2h | mat3x3h | mat3x4h | mat4x2h | mat4x3h | mat4x4h;
...
export type TextureDesc = texture1d | texture2d | texture2dArray | texture3d | textureCube | textureCubeArray | textureMultisampled2d;
/** Non-cube sampled textures — used by TextureNode. */
export type FlatSampledTextureDesc = texture1d | texture2d | texture2dArray | texture3d | textureMultisampled2d;
...
export type SampleTypeOf<D> = D extends {
    readonly sampleType: infer S extends TextureSampleType;
} ? S : never;
/**
 ...
 * - Depth textures → f32
 */
export type TextureSampleResultOf<D extends AnyTextureDesc> = D extends DepthTextureDesc ? f32 : D extends {
    readonly sampleType: infer S extends TextureSampleType;
...
export type textureDepthCubeArray = {
    ...
    readonly wgslType: 'texture_depth_cube_array';
};
...
export type textureDepthMultisampled2d = {
    ...
    readonly wgslType: 'texture_depth_multisampled_2d';
};
export declare const textureDepthMultisampled2d: textureDepthMultisampled2d;
/** Union of all depth texture descriptors. */
export type DepthTextureDesc = textureDepth2d | textureDepth2dArray | textureDepthCube | textureDepthCubeArray | textureDepthMultisampled2d;
...
export declare const voidDesc: voidDesc;
...
export type VecElementDesc<D extends Any> = D extends vec2f | vec3f | vec4f ? f32 : D extends vec2i | vec3i | vec4i ? i32 : D extends vec2u | vec3u | vec4u ? u32 : D extends vec2h | vec3h | vec4h ? f16 : D extends vec2bool | vec3bool | vec4bool ? bool : D extends ScalarDesc ? D : Any;
/** Map a vec or scalar descriptor to its corresponding vec2 type */
export type Vec2DescOf<D extends Any> = D extends vec2f | vec3f | vec4f | f32 ? vec2f : D extends vec2i | vec3i | vec4i | i32 ? vec2i : D extends vec2u | vec3u | vec4u | u32 ? vec2u : D extends vec2h | vec3h | vec4h | f16 ? vec2h : D extends vec2bool | vec3bool | vec4bool | bool ? vec2bool : Vec2Desc;
/** Map a vec or scalar descriptor to its corresponding vec3 type */
export type Vec3DescOf<D extends Any> = D extends vec2f | vec3f | vec4f | f32 ? vec3f : D extends vec2i | vec3i | vec4i | i32 ? vec3i : D extends vec2u | vec3u | vec4u | u32 ? vec3u : D extends vec2h | vec3h | vec4h | f16 ? vec3h : D extends vec2bool | vec3bool | vec4bool | bool ? vec3bool : Vec3Desc;
/** Map a vec or scalar descriptor to its corresponding vec4 type */
export type Vec4DescOf<D extends Any> = D extends vec2f | vec3f | vec4f | f32 ? vec4f : D extends vec2i | vec3i | vec4i | i32 ? vec4i : D extends vec2u | vec3u | vec4u | u32 ? vec4u : D extends vec2h | vec3h | vec4h | f16 ? vec4h : D extends vec2bool | vec3bool | vec4bool | bool ? vec4bool : Vec4Desc;
/**
...
export declare function isAtomicDesc(desc: Any): desc is anyAtomic;
export declare function isStructDesc(desc: Any): desc is StructDesc;
export declare function isArrayDesc(desc: Any): desc is ArrayDesc;
export declare function isSizedArrayDesc(desc: Any): desc is SizedArrayDesc;
export declare function isTextureDesc(desc: Any): desc is TextureDesc;
export declare function isDepthTextureDesc(desc: Any): desc is DepthTextureDesc;
export declare function isAnyTextureDesc(desc: Any): desc is AnyTextureDesc;
export declare function isCubeTextureDesc(desc: AnyTextureDesc): boolean;
export declare function isCubeArrayTextureDesc(desc: AnyTextureDesc): boolean;
export declare function isArrayTextureDesc(desc: AnyTextureDesc): boolean;
/** Returns the GPUTextureDimension for a texture schema type */
export declare function textureDimension(desc: AnyTextureDesc): GPUTextureDimension;
/** Returns the GPUTextureViewDimension for a texture schema type */
export declare function textureViewDimension(desc: AnyTextureDesc): GPUTextureViewDimension;
export declare function isSamplerDesc(desc: Any): desc is SamplerDesc;
export declare function isSamplerComparisonDesc(desc: Any): desc is SamplerComparisonDesc;
export declare function isMatDesc(desc: Any): desc is MatDesc;
export declare function isVecDesc(desc: Any): desc is anyVec;
...
export type ElementOf<D extends Any> = D extends {
    ...
    readonly type: 'sized-array';
    readonly element: infer E extends Any;
} ? E : D extends MatDesc ? MatColumnDesc<D> : D extends anyVec ? VecElementDesc<D> : never;
...
export declare function vec2DescOf(desc: Any): Vec2Desc;
export declare function vec3DescOf(desc: Any): Vec3Desc;
export declare function vec4DescOf(desc: Any): Vec4Desc;
export declare function matColumnDesc(desc: MatDesc): anyVec;
