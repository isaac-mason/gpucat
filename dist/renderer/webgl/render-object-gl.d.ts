...
export declare function createRenderObjectGlCache(): RenderObjectGlCache;
/** Get the WebGL device payload for a RenderObject, lazily creating the entry. */
export declare function getRenderObjectGl(cache: RenderObjectGlCache, renderObject: RenderObject): RenderObjectGl;
