...
/* <RenderType type="import('gpucat').TypeName" /> */
const renderTypeRegex = /<RenderType\s+type=["']import\(['"]gpucat['"]\)\.(\w+)["']\s*\/>/g;
...
/* <RenderSource type="import('gpucat').TypeName" /> */
const renderSourceRegex = /<RenderSource\s+type=["']import\(['"]gpucat['"]\)\.(\w+)["']\s*\/>/g;
