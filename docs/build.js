...
const SECTIONS = [
    ...
    },
    {
        ...
        groups: [
            ...
            { title: 'Textures', modules: ['texture/texture', 'texture/source', 'texture/canvas-texture', 'texture/cube-texture', 'texture/depth-texture', 'texture/array-texture', 'texture/data-texture', 'texture/texture-3d'] },
        ],
    },
    {
        title: 'Compilation',
