...
export class Data3DTexture {
    ...
    constructor(data: DataTextureImage['data'] = null, width = 1, height = 1, depth = 1, options: TextureOptions = {}) {
        ...
        const src = data !== null ? new Source<Texture3DImage>({ data, width, height, depth }) : null;
    ...
    clone(): Data3DTexture {
        ...
        const tex = new Data3DTexture(img?.data ?? null, this.width, this.height, this.depth, {
            wrapS: this.wrapS,
            wrapT: this.wrapT,
...
export function createData3DTexture(
