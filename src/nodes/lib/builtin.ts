...
export class BuiltinNode<D extends WgslDesc> extends Node<D> {
    constructor(
...
export const builtin = <D extends WgslDesc>(builtinKind: BuiltinKind, desc: D) => new BuiltinNode(builtinKind, desc);

/** @builtin(instance_index) — the instance index for instanced draw calls. */
export const instanceIndex: BuiltinNode<d.U32Desc> = /*@__PURE__*/ builtin('instance_index', d.u32);

/** @builtin(vertex_index) — the vertex index in the current draw call. */
export const vertexIndex: BuiltinNode<d.U32Desc> = /*@__PURE__*/ builtin('vertex_index', d.u32);

/** @builtin(global_invocation_id) — unique thread ID across the entire dispatch. */
export const globalId: BuiltinNode<d.Vec3uDesc> = /*@__PURE__*/ builtin('global_invocation_id', d.vec3u);

/** @builtin(local_invocation_id) — thread ID within its workgroup. */
export const localId: BuiltinNode<d.Vec3uDesc> = /*@__PURE__*/ builtin('local_invocation_id', d.vec3u);

/** @builtin(local_invocation_index) — flat 1-D index within the workgroup. */
export const localIndex: BuiltinNode<d.U32Desc> = /*@__PURE__*/ builtin('local_invocation_index', d.u32);

/** @builtin(workgroup_id) — workgroup coordinate in the dispatch grid. */
export const workgroupId: BuiltinNode<d.Vec3uDesc> = /*@__PURE__*/ builtin('workgroup_id', d.vec3u);

/** @builtin(num_workgroups) — total number of workgroups dispatched. */
export const numWorkgroups: BuiltinNode<d.Vec3uDesc> = /*@__PURE__*/ builtin('num_workgroups', d.vec3u);
 ...
 */
export const fragCoord: BuiltinNode<d.Vec4fDesc> = /*@__PURE__*/ builtin('position', d.vec4f);
