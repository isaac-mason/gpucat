...
// Scalars and vectors carry their component `scalar` kind and component count `len` as fields so the
// backends read them directly instead of re-deriving from the `wgslType` string (regex/`===` ladders).
// The component kind is the same for a scalar and its vectors (vec3f -> 'f32'); `len` is 1 for a scalar.
export type f32 = { type: 'f32'; wgslType: 'f32'; glslType: 'float'; scalar: 'f32'; len: 1 };
export const f32: f32 = { type: 'f32', wgslType: 'f32', glslType: 'float', scalar: 'f32', len: 1 };

export type i32 = { type: 'i32'; wgslType: 'i32'; glslType: 'int'; scalar: 'i32'; len: 1 };
export const i32: i32 = { type: 'i32', wgslType: 'i32', glslType: 'int', scalar: 'i32', len: 1 };

export type u32 = { type: 'u32'; wgslType: 'u32'; glslType: 'uint'; scalar: 'u32'; len: 1 };
export const u32: u32 = { type: 'u32', wgslType: 'u32', glslType: 'uint', scalar: 'u32', len: 1 };

export type bool = { type: 'bool'; wgslType: 'bool'; glslType: 'bool'; scalar: 'bool'; len: 1 };
export const bool: bool = { type: 'bool', wgslType: 'bool', glslType: 'bool', scalar: 'bool', len: 1 };

export type f16 = { type: 'f16'; wgslType: 'f16'; scalar: 'f16'; len: 1 };
export const f16: f16 = { type: 'f16', wgslType: 'f16', scalar: 'f16', len: 1 };

export type Scalar = f32 | i32 | u32 | bool | f16;

/* vec2 descriptors */

export type vec2f = { type: 'vec2f'; wgslType: 'vec2f'; glslType: 'vec2'; scalar: 'f32'; len: 2 };
export const vec2f: vec2f = { type: 'vec2f', wgslType: 'vec2f', glslType: 'vec2', scalar: 'f32', len: 2 };

export type vec2i = { type: 'vec2i'; wgslType: 'vec2i'; glslType: 'ivec2'; scalar: 'i32'; len: 2 };
export const vec2i: vec2i = { type: 'vec2i', wgslType: 'vec2i', glslType: 'ivec2', scalar: 'i32', len: 2 };

export type vec2u = { type: 'vec2u'; wgslType: 'vec2u'; glslType: 'uvec2'; scalar: 'u32'; len: 2 };
export const vec2u: vec2u = { type: 'vec2u', wgslType: 'vec2u', glslType: 'uvec2', scalar: 'u32', len: 2 };

export type vec2bool = { type: 'vec2<bool>'; wgslType: 'vec2<bool>'; glslType: 'bvec2'; scalar: 'bool'; len: 2 };
export const vec2bool: vec2bool = {
    type: 'vec2<bool>',
    wgslType: 'vec2<bool>',
    glslType: 'bvec2',
    scalar: 'bool',
...
export type vec2h = { type: 'vec2h'; wgslType: 'vec2h'; scalar: 'f16'; len: 2 };
export const vec2h: vec2h = { type: 'vec2h', wgslType: 'vec2h', scalar: 'f16', len: 2 };

export type Vec2 = vec2f | vec2i | vec2u | vec2bool | vec2h;

/* vec3 descriptors */

export type vec3f = { type: 'vec3f'; wgslType: 'vec3f'; glslType: 'vec3'; scalar: 'f32'; len: 3 };
export const vec3f: vec3f = { type: 'vec3f', wgslType: 'vec3f', glslType: 'vec3', scalar: 'f32', len: 3 };

export type vec3i = { type: 'vec3i'; wgslType: 'vec3i'; glslType: 'ivec3'; scalar: 'i32'; len: 3 };
export const vec3i: vec3i = { type: 'vec3i', wgslType: 'vec3i', glslType: 'ivec3', scalar: 'i32', len: 3 };

export type vec3u = { type: 'vec3u'; wgslType: 'vec3u'; glslType: 'uvec3'; scalar: 'u32'; len: 3 };
export const vec3u: vec3u = { type: 'vec3u', wgslType: 'vec3u', glslType: 'uvec3', scalar: 'u32', len: 3 };

export type vec3bool = { type: 'vec3<bool>'; wgslType: 'vec3<bool>'; glslType: 'bvec3'; scalar: 'bool'; len: 3 };
export const vec3bool: vec3bool = {
    type: 'vec3<bool>',
    wgslType: 'vec3<bool>',
    glslType: 'bvec3',
    scalar: 'bool',
...
export type vec3h = { type: 'vec3h'; wgslType: 'vec3h'; scalar: 'f16'; len: 3 };
export const vec3h: vec3h = { type: 'vec3h', wgslType: 'vec3h', scalar: 'f16', len: 3 };

export type Vec3 = vec3f | vec3i | vec3u | vec3bool | vec3h;

/* vec4 descriptors */

export type vec4f = { type: 'vec4f'; wgslType: 'vec4f'; glslType: 'vec4'; scalar: 'f32'; len: 4 };
export const vec4f: vec4f = { type: 'vec4f', wgslType: 'vec4f', glslType: 'vec4', scalar: 'f32', len: 4 };

export type vec4i = { type: 'vec4i'; wgslType: 'vec4i'; glslType: 'ivec4'; scalar: 'i32'; len: 4 };
export const vec4i: vec4i = { type: 'vec4i', wgslType: 'vec4i', glslType: 'ivec4', scalar: 'i32', len: 4 };

export type vec4u = { type: 'vec4u'; wgslType: 'vec4u'; glslType: 'uvec4'; scalar: 'u32'; len: 4 };
export const vec4u: vec4u = { type: 'vec4u', wgslType: 'vec4u', glslType: 'uvec4', scalar: 'u32', len: 4 };

export type vec4bool = { type: 'vec4<bool>'; wgslType: 'vec4<bool>'; glslType: 'bvec4'; scalar: 'bool'; len: 4 };
export const vec4bool: vec4bool = {
    type: 'vec4<bool>',
    wgslType: 'vec4<bool>',
    glslType: 'bvec4',
    scalar: 'bool',
...
export type vec4h = { type: 'vec4h'; wgslType: 'vec4h'; scalar: 'f16'; len: 4 };
export const vec4h: vec4h = { type: 'vec4h', wgslType: 'vec4h', scalar: 'f16', len: 4 };
...
export type SampleResultOf<S extends TextureSampleType> = S extends f32
    ? vec4f
    : S extends i32
      ? vec4i
      : S extends u32
...
export type SampleTypeOf<D> = D extends { sampleType: infer S extends TextureSampleType } ? S : never;
 ...
 * - Depth textures → f32
 */
export type TextureSampleResultOf<D extends Texture> = D extends DepthTexture
    ? f32
    : D extends { sampleType: infer S extends TextureSampleType }
      ? SampleResultOf<S>
      : never;
...
export const textureDepthCubeArray: textureDepthCubeArray = {
...
export const textureDepthMultisampled2d: textureDepthMultisampled2d = {
...
export type StorageValueOf<F extends StorageTextureFormat> = (typeof STORAGE_FORMATS)[F]['channel'] extends 'u32'
    ? vec4u
    : (typeof STORAGE_FORMATS)[F]['channel'] extends 'i32'
      ? vec4i
      : vec4f;
...
export type textureStorage1d<
    F extends StorageTextureFormat = StorageTextureFormat,
    A extends StorageTextureAccess = StorageTextureAccess,
> = {
...
export function textureStorage1d<F extends StorageTextureFormat = 'rgba8unorm', A extends StorageTextureAccess = 'write'>(
    format?: F,
    access?: A,
): textureStorage1d<F, A> {
    const f = (format ?? 'rgba8unorm') as F;
    const a = (access ?? 'write') as A;
    return { type: 'texture_storage_1d', wgslType: `texture_storage_1d<${f}, ${a}>`, dim: '1d', format: f, access: a };
}

export type textureStorage2d<
    F extends StorageTextureFormat = StorageTextureFormat,
    A extends StorageTextureAccess = StorageTextureAccess,
> = {
...
export function textureStorage2d<F extends StorageTextureFormat = 'rgba8unorm', A extends StorageTextureAccess = 'write'>(
    format?: F,
    access?: A,
): textureStorage2d<F, A> {
    const f = (format ?? 'rgba8unorm') as F;
    const a = (access ?? 'write') as A;
    return { type: 'texture_storage_2d', wgslType: `texture_storage_2d<${f}, ${a}>`, dim: '2d', format: f, access: a };
}

export type textureStorage2dArray<
    F extends StorageTextureFormat = StorageTextureFormat,
    A extends StorageTextureAccess = StorageTextureAccess,
> = {
...
export function textureStorage2dArray<F extends StorageTextureFormat = 'rgba8unorm', A extends StorageTextureAccess = 'write'>(
    format?: F,
    access?: A,
): textureStorage2dArray<F, A> {
    const f = (format ?? 'rgba8unorm') as F;
    const a = (access ?? 'write') as A;
    return {
        type: 'texture_storage_2d_array',
...
export function textureStorage3d<F extends StorageTextureFormat = 'rgba8unorm', A extends StorageTextureAccess = 'write'>(
    format?: F,
    access?: A,
): textureStorage3d<F, A> {
    const f = (format ?? 'rgba8unorm') as F;
    const a = (access ?? 'write') as A;
...
export type MulResultDesc<A extends Any, B extends Any> =
    IsMat<A> extends true ? (IsVec<B> extends true ? B : A) : IsScalar<B> extends true ? A : IsScalar<A> extends true ? B : A;
...
export type CompareResultDesc<D extends Any> = D extends vec2f | vec2i | vec2u | vec2h
    ? vec2bool
    : D extends vec3f | vec3i | vec3u | vec3h
      ? vec3bool
      : D extends vec4f | vec4i | vec4u | vec4h
        ? vec4bool
        : bool;

/** Extract the element descriptor from a vec descriptor, or return self for scalars */
export type VecElementDesc<D extends Any> = D extends vec2f | vec3f | vec4f
    ? f32
    : D extends vec2i | vec3i | vec4i
      ? i32
      : D extends vec2u | vec3u | vec4u
        ? u32
        : D extends vec2h | vec3h | vec4h
          ? f16
          : D extends vec2bool | vec3bool | vec4bool
            ? bool
            : D extends Scalar
              ? D
              : Any;
...
export type Vec2DescOf<D extends Any> = D extends vec2f | vec3f | vec4f | f32
    ? vec2f
...
export type Vec3DescOf<D extends Any> = D extends vec2f | vec3f | vec4f | f32
    ? vec3f
    : D extends vec2i | vec3i | vec4i | i32
      ? vec3i
      : D extends vec2u | vec3u | vec4u | u32
...
export type Vec4DescOf<D extends Any> = D extends vec2f | vec3f | vec4f | f32
    ? vec4f
    : D extends vec2i | vec3i | vec4i | i32
      ? vec4i
      : D extends vec2u | vec3u | vec4u | u32
 ...
 */
export type TypedArrayFor<D extends Any> = D extends i32 | vec2i | vec3i | vec4i
    ? Int32Array
    : D extends u32 | vec2u | vec3u | vec4u
      ? Uint32Array
      : D extends
              | f32
              | vec2f
...
export function isTextureDesc(desc: Any): desc is SampledTexture {
    return (
        desc.type.startsWith('texture_') && !desc.type.startsWith('texture_depth_') && !desc.type.startsWith('texture_storage_')
    );
}
...
export function array<E extends Any>(
    element: E,
): { type: 'array'; wgslType: `array<${E['wgslType']}>`; element: E; length?: undefined } {
...
export function sizedArray<E extends Any, N extends number>(
    element: E,
    length: N,
): { type: 'sized-array'; wgslType: `array<${E['wgslType']}, ${N}>`; element: E; length: N } {
    return { type: 'sized-array', wgslType: `array<${element.wgslType}, ${length}>`, element, length };
}

export type ArrayElement<D extends Any> = D extends { type: 'array'; element: infer E extends Any }
    ? E
...
export type MatColumnDesc<D extends Any> = D extends mat2x2f | mat3x2f | mat4x2f
    ? vec2f
    : D extends mat2x3f | mat3x3f | mat4x3f
      ? vec3f
      : D extends mat2x4f | mat3x4f | mat4x4f
        ? vec4f
        : D extends mat2x2h | mat3x2h | mat4x2h
          ? vec2h
          : D extends mat2x3h | mat3x3h | mat4x3h
            ? vec3h
            : D extends mat2x4h | mat3x4h | mat4x4h
              ? vec4h
              : never;

/* elementOf, element type for bracket indexing; array[i] → element, matrix[i] → column vector, vector[i] → scalar */

export type ElementOf<D extends Any> = D extends { type: 'array'; element: infer E extends Any }
    ? E
    : D extends { type: 'sized-array'; element: infer E extends Any }
      ? E
      : D extends Mat
