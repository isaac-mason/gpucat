export class Graph {
    maxPoints: number;
    lines: Record<string, { path: SVGPathElement; color: string; points: number[] }>;
    limit: number;
    limitIndex: number;
