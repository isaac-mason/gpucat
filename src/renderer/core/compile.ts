...
export type CompilableRenderer = {
    ...
    backend: { compileCompute(nodes: ComputeNode[]): Promise<void> };
};
 ...
 */
export function compile(renderer: CompilableRenderer, drawables: Mesh | Mesh[], target: Target, camera: View): Promise<void> {
...
export function compileCompute(renderer: CompilableRenderer, nodes: ComputeNode | ComputeNode[]): Promise<void> {
