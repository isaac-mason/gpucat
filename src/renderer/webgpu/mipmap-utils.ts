 ...
 */
export function generateMipmaps2D(state: MipmapState, texture: GPUTexture, encoder?: GPUCommandEncoder): void {
 ...
 * @param encoder - Optional command encoder (creates one if not provided)
 */
export function generateMipmapsCube(state: MipmapState, texture: GPUTexture, encoder?: GPUCommandEncoder): void {
