...
export type BufferCache = {
    ...
    storageMap: WeakMap<StorageNode<WgslType>, { buf: GPUBuffer; version: number }>;
 ...
 */
export function uploadStorage(cache: BufferCache, node: StorageNode<WgslType>): GPUBuffer {
